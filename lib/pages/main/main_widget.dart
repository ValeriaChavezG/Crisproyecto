                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: StreamBuilder<List<BeatsRecord>>(
                        stream: queryBeatsRecord(),
                        builder: (context, snapshot) {
                          ...
                          List<BeatsRecord> listViewBeatsRecordList =
                              snapshot.data!;
                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            itemCount: listViewBeatsRecordList.length,
                            itemBuilder: (context, listViewIndex) {
                              final listViewBeatsRecord =
                                  listViewBeatsRecordList[listViewIndex];
                              return Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    10.0, 10.0, 10.0, 10.0),
                                child: Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              context.pushNamed('insertarBeat');
                            },
                            text: 'Agregar',
                            icon: Icon(
