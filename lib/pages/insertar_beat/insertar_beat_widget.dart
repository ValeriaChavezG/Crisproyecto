...
import 'insertar_beat_model.dart';
export 'insertar_beat_model.dart';

class InsertarBeatWidget extends StatefulWidget {
  const InsertarBeatWidget({Key? key}) : super(key: key);

  @override
  _InsertarBeatWidgetState createState() => _InsertarBeatWidgetState();
}

class _InsertarBeatWidgetState extends State<InsertarBeatWidget>
    with TickerProviderStateMixin {
  late InsertarBeatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InsertarBeatModel());
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 12.0, 0.0, 24.0),
                                      child: Text(
                                        'Inserta los datos del nuevo beat',
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge,
                                      ),
